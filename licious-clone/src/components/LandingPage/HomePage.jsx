  ...
  return (
    <div>
      ...
      <Box marginLeft="116px">
        ...
        <Box className="subtitle_text_name">Freshest meats just for you</Box>
                  ...
                  <Box className="best_seller_item_action">
                    <Box className="rate">
                      ...
                      <span color="#aeaeae">
                        ...
                        <span className="line_through" color="#aeaeae">
                          {" "}
                          ₹{el.mrp}
                        </span>
                      </span>
      ...
      <Box className="reward_section" display="flex">
        <Box className="reward_banner" display="flex">
          ...
          <Box className="next_reward">
            <Text className="desc">
              Place an order and win you next reward !
            </Text>
          </Box>
        </Box>
      </Box>
